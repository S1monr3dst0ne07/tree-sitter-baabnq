...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [45] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(36),
  ...
  [57] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(39),
  [60] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(42),
  [63] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(59),
  [66] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(43),
  ...
  [75] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(17),
  [78] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(45),
  [81] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2), SHIFT_REPEAT(46),
  ...
  [89] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_var, 2),
  [91] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_var, 2),
  [93] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unit, 1),
  [95] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unit, 1),
  [97] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement, 2),
  [99] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement, 2),
  ...
  [107] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_expr, 1),
  [109] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_paran, 3),
  [111] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_paran, 3),
  ...
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_print, 2),
  [141] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_putchr, 2),
  [143] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_cond, 4),
  [145] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_push, 2),
  [147] = {.entry = {.count = 1, .reusable = true}}, SHIFT(27),
  [149] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sub, 2),
  [151] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_op, 1),
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_jump, 2),
  ...
  [163] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pull, 2),
  ...
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_sub, 3),
  [173] = {.entry = {.count = 1, .reusable = true}}, SHIFT(41),
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_new, 3),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_static, 3),
  [179] = {.entry = {.count = 1, .reusable = true}}, SHIFT(4),
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_input, 2),
  ...
  [191] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lab, 2),
};
